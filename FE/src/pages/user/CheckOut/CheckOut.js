                ...
                <div className="row">
                        ...
                        <form className="card p-2">
                            <div className="input-group">
                                ...
                                <div className="input-group-append">
                                    <button type="button" className="btn btn-secondary">Thanh toán</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div className="col-md-8 order-md-1">
                        ...
                        <form className="needs-validation" novalidate>
                            ...
                            <div className="mb-3">
                                <label for="address2">Địa chỉ 2 <span className="text-muted">(Optional)</span></label>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-4 mb-3">
                                    ...
                                    <select className="custom-select d-block w-100 h-75" id="state" required>
                            ...
                            <hr className="mb-4" />
                            <button className="btn btn-primary btn-lg btn-block" type="button">Thanh toán</button>
                        </form>
                    </div>
                </div>
